...
//           success: false,
//           message: "reseller ID is required for Center type",
//         });
//       }
...
//     }
//     }
//     const resellerData = centerType === "Center" ? resellerId : undefined;
...
//           return res.status(400).json({
//             success: false,
//             message: "reseller ID is required when changing to Center type",
//           });
//         }
...
//         return res.status(400).json({
//           success: false,
//           message: "reseller can only be assigned to Center type",
//         });
//       }
//     }
...
//     let filter = { reseller: req.params.resellerId };

//     if (canViewOwn && !canViewAll && req.user.center) {
//       const userCenter = await Center.findById(req.user.center);
//       if (
//         !userCenter ||
//         userCenter.reseller.toString() !== req.params.resellerId
//       ) {
//         return res.status(403).json({
//           success: false,
//           message: "Access denied. You can only view centers in your reseller.",
//         });
//       }
//       filter._id = req.user.center._id || req.user.center;
//     }
